  ...
  def test_process_muse_data(self):
    ...
    expected_output = [
      {"className": "fixr.plv.colorado.edu.awesomeapp.MainActivity",
       ...
       "line": 47,
       "id": 1,
      "fileName": "[MainActivity.java](https://github.com/cuplv/AwesomeApp/blob/04f68b69a6f9fa254661b481a757fa1c834b52e1/MainActivity.java)"
      },
      {
        "className": "fixr.plv.colorado.edu.awesomeapp.MainActivity",
        "methodName": "showDialog",
    ...
    expected_data = json.dumps(expected_output, sort_keys=True)
    got_data = json.dumps(json_data, sort_keys=True)
